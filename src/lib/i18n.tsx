...
export const translations: Record<Lang, Dict> = {
  uz: {
    ...
    "hero.title.brand": "Daymilk – tabiiy,",
    "hero.title.line2": "sifatli va mazali",
    "hero.title.line3": "sut mahsulotlari",
    "hero.desc":
    ...
    "product.nutritional": "100 g mahsulotdagi tarkib:",
    "product.protein": "Oqsil",
    "product.fats": "Yog'lar",
    "product.carbs": "Uglevodlar",
    "product.calories": "Energiya qiymati",
    "product.storage": "Saqlash sharoiti",
    "product.shelf": "Yaroqlik muddati",

    "storage.refrigerated": "+2°C dan +6°C da saqlash",
    "shelf.days10": "10 kun",
    "shelf.days14": "14 kun",
    "shelf.days20": "20 kun",

    "partnership.title": "Hamkorlik qilishni hohlaysizmi?",
    "partnership.subtitle": "Ulgurji buyurtmalar va hamkorlik imkoniyatlari uchun biz bilan bog'laning",
    "partnership.phone": "Telefon",
    "partnership.email": "Email",
    "partnership.telegram": "Telegram",
  },
  ru: {
    "nav.home": "Главная",
    ...
    "hero.title.brand": "Daymilk — натуральные,",
    "hero.title.line2": "качественные и вкусные",
    "hero.title.line3": "молочные продукты",
    ...
    "product.nutritional": "Состав на 100 г продукта:",
    "product.protein": "Белки",
    "product.fats": "Жиры",
    "product.carbs": "Углеводы",
    "product.calories": "Энергетическая ценность",
    "product.storage": "Условия хранения",
    "product.shelf": "Срок годности",

    "storage.refrigerated": "От +2°C до +6°C",
    "shelf.days10": "10 дней",
    "shelf.days14": "14 дней",
    "shelf.days20": "20 дней",

    "partnership.title": "Хотите сотрудничать?",
    "partnership.subtitle": "Свяжитесь с нами для оптовых заказов и партнёрских возможностей",
    "partnership.phone": "Телефон",
    "partnership.email": "Email",
    "partnership.telegram": "Telegram",
  },
  en: {
    ...
    "hero.title.brand": "Daymilk — natural,",
    "hero.title.line2": "quality and delicious",
    "hero.title.line3": "dairy products",
    ...
    "product.nutritional": "Nutritional value per 100g:",
    "product.protein": "Protein",
    "product.fats": "Fats",
    "product.carbs": "Carbohydrates",
    "product.calories": "Energy value",
    "product.storage": "Storage conditions",
    "product.shelf": "Shelf life",

    "storage.refrigerated": "+2°C to +6°C",
    "shelf.days10": "10 days",
    "shelf.days14": "14 days",
    "shelf.days20": "20 days",

    "partnership.title": "Want to cooperate?",
    "partnership.subtitle": "Contact us for wholesale orders and partnership opportunities",
